---
name: humanizer
description: Remove signs of AI-generated writing from text. Use when drafting or editing copy to make it sound natural and human-written. 33 patterns from Wikipedia's "Signs of AI writing" + voice/personality pass.
metadata:
  trigger: Writing or editing copy, posts, scripts, emails before delivering
  author: blader (https://github.com/blader/humanizer) v2.8.2, adaptado Automiq
---

> Adaptación Automiq (headless): corrés sin usuario interactivo — NUNCA preguntes ni
> esperes writing samples; aplicá directamente el default (voz natural, variada, con
> opinión). El copy de Automiq es ESPAÑOL RIOPLATENSE (vos/mirá/fijate): los patrones
> de acá aplican igual (em dashes, rule of three, muletillas de cierre, negritas de
> más, "no es X, es Y"), pero las listas de vocabulario en inglés tienen equivalentes
> ("crucial", "clave", "sumergite", "en el mundo de", "no solo... sino que...",
> "cabe destacar", "sin duda", "revolucionario") — tratalos igual que sus pares EN.
