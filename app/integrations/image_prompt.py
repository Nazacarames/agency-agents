...
_SYSTEM = (
    ...
    "3. Composición pensada para un titular: el SUJETO (cara y torso) va en los dos "
    "tercios SUPERIORES del cuadro; el tercio INFERIOR queda como espacio más despejado y "
    "oscuro (piso, sombra, mesada) donde va a ir una banda de texto. NUNCA pongas la cara "
    "en el centro exacto ni ocupando todo el alto. Encuadre a media distancia (no primerísimo "
    "primer plano).\n"
